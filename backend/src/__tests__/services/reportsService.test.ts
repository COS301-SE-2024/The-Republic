...
describe("ReportsService", () => {
  ...
  beforeEach(() => {
    ...
    reportsRepository = new ReportsRepository() as jest.Mocked<ReportsRepository>;
  ...
  describe("getAllIssuesGroupedByResolutionStatus", () => {
    it("should return all issues grouped by resolution status", async () => {
      ...
      const response = await reportsService.getAllIssuesGroupedByResolutionStatus(params);
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getAllIssuesGroupedByResolutionStatus(params)).rejects.toEqual(
  ...
  describe("getIssueCountsGroupedByResolutionStatus", () => {
    it("should return issue counts grouped by resolution status", async () => {
      ...
      const response = await reportsService.getIssueCountsGroupedByResolutionStatus(params);
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getIssueCountsGroupedByResolutionStatus(params)).rejects.toEqual(
        expect.objectContaining({
          code: 404,
          success: false,
  ...
  describe("getIssueCountsGroupedByResolutionAndCategory", () => {
    it("should return issue counts grouped by resolution and category", async () => {
      ...
      const response = await reportsService.getIssueCountsGroupedByResolutionAndCategory(params);
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getIssueCountsGroupedByResolutionAndCategory(params)).rejects.toEqual(
        expect.objectContaining({
          code: 404,
          success: false,
  ...
  describe("getIssuesGroupedByCreatedAt", () => {
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getIssuesGroupedByCreatedAt(params)).rejects.toEqual(
        expect.objectContaining({
          code: 404,
          success: false,
  ...
  describe("getIssuesGroupedByCategory", () => {
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getIssuesGroupedByCategory(params)).rejects.toEqual(
        expect.objectContaining({
          code: 404,
          success: false,
  ...
  describe("getIssuesCountGroupedByCategoryAndCreatedAt", () => {
    it("should return issue counts grouped by category and creation date", async () => {
      ...
      const response = await reportsService.getIssuesCountGroupedByCategoryAndCreatedAt(params);
    ...
    it("should throw an error when something goes wrong", async () => {
      ...
      await expect(reportsService.getIssuesCountGroupedByCategoryAndCreatedAt(params)).rejects.toEqual(
        expect.objectContaining({
          code: 404,
          success: false,
