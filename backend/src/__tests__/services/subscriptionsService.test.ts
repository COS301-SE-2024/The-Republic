...
describe("SubscriptionsService", () => {
  ...
  describe("issueSubscriptions", () => {
    ...
    it("should throw an APIError on failure", async () => {
      ...
      await expect(subscriptionsService.issueSubscriptions({})).rejects.toEqual(
        APIError({ code: 404, success: false, error: "Issue: Something Went wrong" })
      );
    });
  });
  ...
  describe("categorySubscriptions", () => {
    ...
    it("should throw an APIError on failure", async () => {
      ...
      await expect(subscriptionsService.categorySubscriptions({})).rejects.toEqual(
        APIError({ code: 404, success: false, error: "Category: Something Went wrong" })
      );
    });
  });
  ...
  describe("locationSubscriptions", () => {
    ...
    it("should throw an APIError on failure", async () => {
      ...
      await expect(subscriptionsService.locationSubscriptions({})).rejects.toEqual(
        APIError({ code: 404, success: false, error: "Location: Something Went wrong" })
      );
    });
  });
  ...
  describe("getSubscriptions", () => {
    ...
    it("should throw an APIError on failure", async () => {
      ...
      await expect(subscriptionsService.getSubscriptions({})).rejects.toEqual(
        APIError({ code: 404, success: false, error: "Notifications: Something Went wrong" })
      );
    });
  });
});