...
describe('Comments Routes', () => {
  ...
  describe('POST /comments/', () => {
    it('should call getComments controller', async () => {
      ...
      (commentController.getComments as jest.Mock).mockImplementation((req, res) => res.status(200).json({}));
  ...
  describe('POST /comments/count', () => {
    it('should call getNumComments controller', async () => {
      (verifyAndGetUser as jest.Mock).mockImplementation((req, res, next) => next());
      (commentController.getNumComments as jest.Mock).mockImplementation((req, res) => res.status(200).json({}));
  ...
  describe('POST /comments/add', () => {
    it('should call addComment controller', async () => {
      (verifyAndGetUser as jest.Mock).mockImplementation((req, res, next) => next());
      (commentController.addComment as jest.Mock).mockImplementation((req, res) => res.status(200).json({}));
  ...
  describe('DELETE /comments/delete', () => {
    it('should call deleteComment controller', async () => {
      (verifyAndGetUser as jest.Mock).mockImplementation((req, res, next) => next());
      (commentController.deleteComment as jest.Mock).mockImplementation((req, res) => res.status(200).json({}));
