...
export const joinOrganization = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.joinOrganization(
      organizationId,
      userId,
    );
    clearCachePattern(
...
export const setJoinPolicy = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.setJoinPolicy(
      organizationId,
      joinPolicy,
      userId,
    );
...
export const getJoinRequests = [
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const response = await organizationService.getJoinRequests(
        organizationId,
        userId,
        paginationParams,
      );
...
export const getJoinRequestByUser = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.getJoinRequestByUser(
      organizationId,
      userId,
    );
    sendResponse(res, response);
...
export const handleJoinRequest = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.handleJoinRequest(
      organizationId,
      requestId,
      accept,
      userId,
...
export const removeMember = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.removeMember(
      organizationId,
      memberUserId,
      adminId,
    );
...
export const deleteJoinRequest = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.deleteJoinRequest(
      requestId,
      userId,
    );
...
export const getOrganizationPosts = [
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const response = await organizationService.getOrganizationPosts(
        organizationId,
        userId,
        paginationParams,
      );
...
export const createOrganizationPost = [
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const response = await organizationService.createOrganizationPost(
        post,
        userId,
        req.file,
      );
      clearCachePattern(
        `__express__/api/organizations/${organizationId}/posts*`,
      );
      sendResponse(res, response);
    } catch (err) {
      handleError(res, err);
...
export const getTopActiveMembers = [
  ...
  async (req: Request, res: Response) => {
    try {
      const organizationId = req.params.id;
      const response =
        await organizationService.getTopActiveMembers(organizationId);
      sendResponse(res, response);
    } catch (err) {
      handleError(res, err);
    }
...
export const promoteToAdmin = async (req: Request, res: Response) => {
  try {
    ...
    const response = await organizationService.addAdmin(
      organizationId,
      adminId,
      memberUserId,
    );
...
export const getOrganizationPost = [
  cacheMiddleware(300),
  async (req: Request, res: Response) => {
    try {
      const organizationId = req.params.id;
      const postId = req.params.postId;
      const response = await organizationService.getOrganizationPost(
        organizationId,
        postId,
        req.body.user_id,
      );
...
export const checkUserMembership = [
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const response = await organizationService.checkUserMembership(
        organizationId,
        userId,
      );
      sendResponse(res, response);
...
export const getActivityLogs = [
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const response = await organizationService.getActivityLogs(
        organizationId,
        userId,
        paginationParams,
      );
