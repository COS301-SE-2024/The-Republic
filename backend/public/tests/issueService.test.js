...
describe("IssueService", () => {
  ...
  describe("createIssue", () => {
    it("should create a new issue when all required fields are provided", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const newIssue = {
          user_id: "1",
          department_id: 1,
        ...
        const createdIssue = Object.assign(Object.assign({}, newIssue), {
          issue_id: 1,
          created_at: "2022-01-01",
        });
    ...
    it("should throw an error when required fields are missing", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect(issueService.createIssue(newIssue)).rejects.toThrowError(
          "Missing required fields for creating an issue",
        );
        expect(issueRepository.createIssue).not.toHaveBeenCalled();
      }));
    it("should throw an error when content exceeds the maximum length", () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const newIssue = {
          user_id: "1",
          department_id: 1,
