...
describe("User Controller", () => {
    ...
    let mockUserService;
    beforeEach(() => {
        mockRequest = { body: {}, params: {}, query: {}, file: {} };
        mockResponse = {
            json: jest.fn(),
        ...
        userService_1.UserService.mockImplementation(() => mockUserService);
    });
    ...
    it("should handle errors in getUserById", () => __awaiter(void 0, void 0, void 0, function* () {
        mockUserService.getUserById.mockRejectedValue(new Error("Test error"));
        yield testControllerMethod("getUserById");
        expect(response_1.sendResponse).toHaveBeenCalled();
    }));
    it("should handle errors in updateUserProfile", () => __awaiter(void 0, void 0, void 0, function* () {
        mockUserService.updateUserProfile.mockRejectedValue(new Error("Test error"));
        yield testControllerMethod("updateUserProfile");
        expect(response_1.sendResponse).toHaveBeenCalled();
    }));
});
