...
describe("Location Routes", () => {
    ...
    describe("POST /locations/", () => {
        it("should call getAllLocations controller", () => __awaiter(void 0, void 0, void 0, function* () {
            locationController.getAllLocations[0].mockImplementation((req, res) => res.status(200).json({}));
            const response = yield (0, supertest_1.default)(app).post("/locations/");
