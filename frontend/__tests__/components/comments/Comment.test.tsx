...
jest.mock('@/components/Comment/AddCommentForm', () => ({ onCommentAdded }: { onCommentAdded: (comment: CommentType) => void }) => (
  <div>
    <button onClick={() => onCommentAdded({ 
...
describe('Comment component', () => {
  ...
  it('renders the comment with user details', () => {
    render(<Comment comment={mockComment} onDelete={jest.fn()} isOwner={true} onReply={jest.fn()} replies={[]} />);
  ...
  it('hides reply and delete buttons if user is not logged in', () => {
    ...
    render(<Comment comment={mockComment} onDelete={jest.fn()} isOwner={false} onReply={jest.fn()} replies={[]} />);
  ...
  it('shows and hides replies', () => {
    render(<Comment comment={mockComment} onDelete={jest.fn()} isOwner={true} onReply={jest.fn()} replies={mockReplies} />);
    
    const showRepliesButton = screen.getByText(`Show replies (${mockReplies.length})`);
  ...
  it('calls onDelete when delete button is clicked', () => {
    ...
    render(<Comment comment={mockComment} onDelete={mockOnDelete} isOwner={true} onReply={jest.fn()} replies={[]} />);
  ...
  it('calls onReply when a reply is submitted', () => {
    ...
    render(<Comment comment={mockComment} onDelete={jest.fn()} isOwner={true} onReply={mockOnReply} replies={[]} />);
