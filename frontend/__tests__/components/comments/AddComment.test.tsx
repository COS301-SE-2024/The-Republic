...
jest.mock('react-textarea-autosize', () => ({
  __esModule: true,
  default: jest.fn((props: React.TextareaHTMLAttributes<HTMLTextAreaElement>) => <textarea {...props} />),
}));
...
describe('AddCommentForm', () => {
  ...
  it('submits a comment', async () => {
    ...
    const fetchMock = jest.fn().mockResolvedValue({
      json: jest.fn().mockResolvedValue({ success: true, data: { content: 'This is a comment' } })
    });
