...
describe('ProfileStats', () => {
  ...
  it('renders profile stats correctly', () => {
    render(<ProfileStats userId="1" totalIssues={10} resolvedIssues={5} selectedTab="issues" setSelectedTab={() => {}} />);
  ...
  it('handles tab click correctly', () => {
    ...
    render(<ProfileStats userId="1" totalIssues={10} resolvedIssues={5} selectedTab="issues" setSelectedTab={setSelectedTab} />);
