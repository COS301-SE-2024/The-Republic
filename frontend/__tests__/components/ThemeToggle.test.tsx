...
describe('ModeToggle', () => {
  ...
  it('calls setTheme with "light" when Light is clicked', async () => {
    render(<ModeToggle />);
    const lightButton = await screen.findByRole('button', { name: /toggle theme/i });
  ...
  it('calls setTheme with "dark" when Dark is clicked', async () => {
    render(<ModeToggle />);
    const darkButton = await screen.findByRole('button', { name: /toggle theme/i });
  ...
  it('calls setTheme with "system" when System is clicked', async () => {
    render(<ModeToggle />);
    const systemButton = await screen.findByRole('button', { name: /toggle theme/i });
